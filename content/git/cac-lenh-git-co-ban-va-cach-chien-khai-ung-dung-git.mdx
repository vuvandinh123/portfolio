---
title: "Các lệnh git cơ bản và cách chiến khải ứng dụng git"
publishedAt: "2024-06-18"
summary: "Hướng dẫn các lệnh git cơ bản và cách chiến khải ứng dụng git"
---
...
git add <file>
```
hoặc `git add .` nêú đẩy tất cả file đã thay đổi hoặc mới tạo
### 4 Tạo log ghi chú
```bash
...
```bash 
git branch <ten nhanh muon tạo>
```
Các kí tự đi kèm `-b` để tạo và truy cập `-d` để xóa nhánh
### 10 Chuyển nhánh
```bash 
git checkout <branch_name>
```
### 11 Tải về các thay đổi từ remote mà không merge
```bash 
git fetch
```
### 12 Cập nhật code từ nhánh khác đến nhánh hiện tại
```bash 
git merge <ten_nhanh>
```
### 13 Push nhánh mới lên github
```bash 
git push -u origin ten-nhanh-moi
```
### 14 Xóa nhánh ở local

```bash 
git branch -d <ten-nhanh>
```

### 15 Xóa nhánh ở github
